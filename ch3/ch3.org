...
#+begin_src scheme
  ...
  (count-pairs y)
#+end_src
 For the last case we simply let =z= to be a cycle using the =make-cycle= procedure from Exercise 3.13 =(define z (make-cycle (cons 'a (cons 'b (cons 'c '())))))=. We show diagrams below
