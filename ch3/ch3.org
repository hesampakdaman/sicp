...
#+end_quote
Suppose connetor =a= has no value and we set connector =b= to 25. Since the relation is a square, we expect the system to
...
#+end_src
Here =product= has a value but none of =m1= nor =m2= have. So no case in =cond= applies and =process-new-value= simply does nothing.
